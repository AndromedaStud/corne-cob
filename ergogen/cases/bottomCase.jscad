...
.union(
    ...
    CAG.circle({"center":[95.2707341,-15.5085036],"radius":1})
                ...
                function bottomCase_case_fn() {
                    

                // creating part 0 of case bottomCase
                let bottomCase__part_0 = _case_outline_extrude_2_outline_fn();

                // make sure that rotations are relative
                let bottomCase__part_0_bounds = bottomCase__part_0.getBounds();
                let bottomCase__part_0_x = bottomCase__part_0_bounds[0].x + (bottomCase__part_0_bounds[1].x - bottomCase__part_0_bounds[0].x) / 2
                let bottomCase__part_0_y = bottomCase__part_0_bounds[0].y + (bottomCase__part_0_bounds[1].y - bottomCase__part_0_bounds[0].y) / 2
                bottomCase__part_0 = translate([-bottomCase__part_0_x, -bottomCase__part_0_y, 0], bottomCase__part_0);
                bottomCase__part_0 = rotate([0,0,0], bottomCase__part_0);
                bottomCase__part_0 = translate([bottomCase__part_0_x, bottomCase__part_0_y, 0], bottomCase__part_0);

                bottomCase__part_0 = translate([0,0,0], bottomCase__part_0);
                let result = bottomCase__part_0;
                
            

                // creating part 1 of case bottomCase
                let bottomCase__part_1 = _bottomWall_case_fn();

                // make sure that rotations are relative
                let bottomCase__part_1_bounds = bottomCase__part_1.getBounds();
                let bottomCase__part_1_x = bottomCase__part_1_bounds[0].x + (bottomCase__part_1_bounds[1].x - bottomCase__part_1_bounds[0].x) / 2
                let bottomCase__part_1_y = bottomCase__part_1_bounds[0].y + (bottomCase__part_1_bounds[1].y - bottomCase__part_1_bounds[0].y) / 2
                bottomCase__part_1 = translate([-bottomCase__part_1_x, -bottomCase__part_1_y, 0], bottomCase__part_1);
                bottomCase__part_1 = rotate([0,0,0], bottomCase__part_1);
                bottomCase__part_1 = translate([bottomCase__part_1_x, bottomCase__part_1_y, 0], bottomCase__part_1);

                bottomCase__part_1 = translate([0,0,0], bottomCase__part_1);
                result = result.union(bottomCase__part_1);
                
            

                // creating part 2 of case bottomCase
                let bottomCase__part_2 = _holes_case_fn();

                // make sure that rotations are relative
                let bottomCase__part_2_bounds = bottomCase__part_2.getBounds();
                let bottomCase__part_2_x = bottomCase__part_2_bounds[0].x + (bottomCase__part_2_bounds[1].x - bottomCase__part_2_bounds[0].x) / 2
                let bottomCase__part_2_y = bottomCase__part_2_bounds[0].y + (bottomCase__part_2_bounds[1].y - bottomCase__part_2_bounds[0].y) / 2
                bottomCase__part_2 = translate([-bottomCase__part_2_x, -bottomCase__part_2_y, 0], bottomCase__part_2);
                bottomCase__part_2 = rotate([0,0,0], bottomCase__part_2);
                bottomCase__part_2 = translate([bottomCase__part_2_x, bottomCase__part_2_y, 0], bottomCase__part_2);

                bottomCase__part_2 = translate([0,0,0], bottomCase__part_2);
                result = result.union(bottomCase__part_2);
